...
<section class="grid gap-6 md:grid-cols-3">
	<div class="rounded-2xl border border-[var(--line)] bg-[var(--surface-2)] p-6">
		...
		<p class="mt-2 text-sm text-[var(--muted)]">
			{data.current ? `${data.current.row_count} rows` : 'Upload a CSV to begin.'}
		</p>
		<a class="mt-4 inline-flex text-sm font-semibold text-[var(--accent)]" href="/admin/csv">
			Manage CSV
		</a>
	</div>
	<div class="rounded-2xl border border-[var(--line)] bg-[var(--surface-2)] p-6">
		...
		<a class="mt-4 inline-flex text-sm font-semibold text-[var(--accent)]" href="/admin/links">
			Manage links
		</a>
	</div>
	<div class="rounded-2xl border border-[var(--line)] bg-[var(--surface-2)] p-6">
		...
		<a class="mt-4 inline-flex text-sm font-semibold text-[var(--accent)]" href="/admin/requests">
			Review requests
		</a>
	</div>
</section>
